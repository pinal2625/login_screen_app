...
import 'package:login_screen_app/sign_up_screen_toast_message.dart';

class LoginScreenToastMessage extends StatefulWidget {
  const LoginScreenToastMessage({Key? key}) : super(key: key);

  @override
  State<LoginScreenToastMessage> createState() =>
      _LoginScreenToastMessageState();
}

class _LoginScreenToastMessageState extends State<LoginScreenToastMessage> {
                    ...
                    child: TextButton(
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                const SignUpScreenToastMessage(),
                          ),
                        );
                      },
                      child: RichText(
